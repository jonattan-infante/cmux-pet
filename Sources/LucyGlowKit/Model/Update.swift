...
// de docs/reference/versioning.md; windows/lucy_win/update.py es la misma
...
/// dijo ya. Misma forma en ambas plataformas para que un mismo ~/.lucy
/// sirva a las dos.
...
public enum UpdateCheck {
    /// El endpoint del contrato. `LUCY_UPDATE_URL` lo reemplaza para probar
    /// sin publicar nada (acepta file://).
    public static let defaultEndpoint =
        "https://api.github.com/repos/jonattan-infante/lucyglow/releases/latest"

    public static var endpoint: URL {
        let raw = ProcessInfo.processInfo.environment["LUCY_UPDATE_URL"] ?? defaultEndpoint
    ...
    public static func fetchLatest(timeout: TimeInterval = 10,
        ...
        req.setValue("lucy/\(lucyGlowVersion)", forHTTPHeaderField: "User-Agent")
