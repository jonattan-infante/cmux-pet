...
public enum Registry {
    /// El indice oficial. Se puede apuntar a otro con LUCY_REGISTRY, que es
    /// como se prueba un registro propio o uno de empresa.
    public static var url: URL {
        if let custom = ProcessInfo.processInfo.environment["LUCY_REGISTRY"],
           let u = URL(string: custom) {
            return u
        }
        return URL(string: "https://raw.githubusercontent.com/jonattan-infante/lucyglow/main/registry.json")!
    }
