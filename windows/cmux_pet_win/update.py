...
# docs/reference/versioning.md; Sources/CmuxPetKit/Model/Update.swift es la
...
DEFAULT_ENDPOINT = "https://api.github.com/repos/jonattan-infante/cmux-pet/releases/latest"
...
def endpoint() -> str:
    # CMUX_PET_UPDATE_URL reemplaza el endpoint para probar sin publicar nada
    # (acepta file://).
    return os.environ.get("CMUX_PET_UPDATE_URL") or DEFAULT_ENDPOINT
...
class UpdateState:
    ...
    un mismo ~/.cmux-pet sirva a las dos plataformas. """
...
def fetch_latest(timeout: float = 10.0):
    ...
    req = urllib.request.Request(endpoint(), headers={
        "User-Agent": f"cmux-pet/{__version__}",
